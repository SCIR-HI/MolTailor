...
LastEditTime: 2023-07-25 10:10:52
FilePath: /workspace/01-st/finetune-moleculenet/models/chemberta_10m_mtr/load.py
Description: 
...
model_path = base_path / 'models/ChemBERTa-10M-MTR'
...
def load_chemberta_10m_mtr_tokenizer(path: PosixPath = model_path) -> AutoTokenizer:
    return AutoTokenizer.from_pretrained(path)


if __name__ == '__main__':
    model = load_chemberta_10m_mtr()
    print(model)