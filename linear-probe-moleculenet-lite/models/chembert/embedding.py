...
Date: 2023-07-29 22:15:39
LastEditors: simwit 517992857@qq.com
LastEditTime: 2023-07-29 22:15:39
FilePath: /workspace/01-st/finetune-moleculenet/models/chembert/embedding.py
Description: 
...
class Smiles_embedding(nn.Module):
    ...
    def forward(self, sequence, pos_num, adj_mask=None, adj_mat=None):
        ...
        if adj_mat is not None:
            ...
            x += adj_mask.unsqueeze(2) * self.adj(adj_mat).repeat(1, x.shape[1]).reshape(-1, x.shape[1], self.embed_size)
        return x
